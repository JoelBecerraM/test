...
CREATE TABLE ListaPrecios (compania varchar(20) not null, noparte varchar(20) not null, 
	pre_naranja double not null, pre_verde double not null, pre_morada double not null, pre_azul double not null, pre_roja double not null, pre_cafe double not null,
	pre_rosa double not null, pre_amarilla double not null, pre_azulmarino double not null,
	pro_normal double not null, pro_especial double not null, 
	PRIMARY KEY (compania, noparte)
	) ENGINE=InnoDB;
...
CREATE TABLE Cliente (compania varchar(20) not null, cliente varchar(20) not null, nombre varchar(200) not null, 
	...
	gerentenacional varchar(100) not null, entidadfederativa varchar(20) not null, codigopostal varchar(5) not null, 
