...
public class CompaniaDAO implements DatabaseRecord, DatabaseRecordABC, java.io.Serializable {
    ...
    public int diferenciahoraria = 0;
    ...
    public void save(DatabaseServices ds, String[] valores) throws Exception {
        ...
        String _direccion = existe ? this.direccion : null;
        ...
        if (existe) {
            ...
            long count = (Long)ds.aggregate(new DireccionDAO(), "COUNT", "direccion") + 1;
            this.direccion = F.f(count, 10, F.ZF);
