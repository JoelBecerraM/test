 ...
 */
public class SetProductsHowManyCommand implements WebCommandInterface {
    static Logger log = Logger.getLogger(SetProductsHowManyCommand.class.getName());
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response, DatabaseServices ds) throws WebException {
        try {
            ...
            pageModel.productsHowMany = Numero.getIntFromString(howmany);
